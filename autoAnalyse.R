## Code for automatically detecting saccades and fixations in all the 
## files containing eye tracking data while separating it into data
## from map and minimap.
## The output of this code is a database with the saccades, fixations,
## mean of fixations and standard deviation of fixations for each of
## the observations from the eye tracking data while differentiating
## the data by type (game or minimap AoIs)
...
fileNames<-list.files(wDirectory, pattern="*.csv", full.names=FALSE) # Import the names of all the files contained in the directory and following the specified pattern.
